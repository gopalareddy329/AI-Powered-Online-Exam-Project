...
def check(username,password,rollno,email) :
    ...
    rollno=rollno+'\n'
    file_name=open("C://Users/LENOVO/Desktop/pariksha/main/authentication/stdb.txt","r")
    i=0
    linenumber=0
...
def face(request):
  ...
  if request.method=='POST':
    ...
    while True:
        ...
        haar_cascade = cv.CascadeClassifier("C://Users/Lenovo/Desktop/pariksha/main/haar_face.xml")
